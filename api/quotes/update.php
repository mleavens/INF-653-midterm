...
}elseif(isset($data->id) && !empty($data->id) && isset($data->quote) && !empty($data->quote) && isset($data->categoryId) && !empty($data->categoryId) && !isset($data->authorId) && empty($data->authorId)){
    echo json_encode(
